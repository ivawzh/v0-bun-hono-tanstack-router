...
1. Title line
2. Badge row (Priority emoji+number, Stage badge, Process badge) — clicking the Stage badge opens the Flow tab
...
1. Title line
2. Badge row (Priority emoji+number, Stage badge, **PR status badge**) — clicking the Stage badge opens the Flow tab
3. Description (collapsible, 3.5 lines visible)
...
- Stage badges are display-only in all columns.
- Clicking the Stage badge opens the Flow tab in the MissionView popup.
- From the Flow tab, users can change the flow, enable/disable stages, toggle per-stage review, or skip to a later stage.
...
│ │ Priority: [High ▼]  Stage: [Code] (click to change)  List: [Doing ▼]    ││
...
│ │ 4. Review      [☑ Enabled] [☑ Require Review]                        │ │
│ └───────────────────────────────────────────────────────────────────────┘ │
└───────────────────────────────────────────────────────────────────────────┘
```
...
- **Stage**: Display-only on cards; change via the Flow tab (shared with Create Mission)
...
- **Flow**: Primary selection - determines the sequence of stages (e.g., "Standard Development", "Quick Fix", "Research & Analysis"). To start later in the sequence, untick Enabled for earlier stages
...
│ │ Stage Sequence:                                                      │   │
│ │ ┌─ Drag to reorder ────────────────────────────────────────────┐     │   │
│ │ │ 1. ☑ Clarify    → [☑ Require Review by default] [⋮]         │     │   │
│ │ │ 2. ☑ Plan       → [☑ Require Review by default] [⋮]         │     │   │
│ │ │ 3. ☑ Code       → [☑ Require Review by default] [⋮]         │     │   │
│ │ └──────────────────────────────────────────────────────────────┘     │   │
│ │ [+ Add Stage]                                                        │   │
│ │                                                                     │   │
│ │                                         [Cancel] [Save Flow]       │   │
...
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│ Missing a workstation? Run: `solo-unicorn workstation register`             │
│                                                                             │
│                                                [← Back] [Cancel] [Next →]   │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│ │                                                                          ││
│ │ (Not in MVP) 🏷️ Tags: react, typescript, stripe, ecommerce, nodejs, postgresql       ││
│ │ (Not in MVP) 📂 Category: Web Development                                             ││
│ │ 🔗 Repositories: github.com/ecommerce-expert/starter-kit (⭐ 89)           ││
│ │                                                                          ││
...
│ │ 💻 2 workstations online (Status Only - no details shown)          ││
│ │                                                                          ││
│ │ (Not in MVP) Recent Activity:                                                         ││
...
│ │                                                                          ││
│ │ Quick Actions:                                                           ││
│ │ [(Not in MVP) ⭐ Star Project] [(Not in MVP) 🍴 Use as Template]        ││
│ │ [📋 Browse Missions] [🤝 Contribute]││                                  ││
│ └──────────────────────────────────────────────────────────────────────────┘│
│                                                              [Close]        │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│ │ • Generate public URL: solounicorn.lol/public-projects/my-project  │   │
│ │                                                                     │   │
...
│ └─────────────────────────────────────────────────────────────────────┘   │
│                                                                           │
│ (Not in MVP) Public Project Preview:                                      │
│ ┌─────────────────────────────────────────────────────────────────────┐   │
...
├─────────────────────────────────────┤
│ 🔗 [View GitHub PR] [(Not in MVP) 💬 PR Comments] │
...
### (Not in MVP) GitHub PR Comments Integration
...
- `(Not in MVP) ✅ Approved` - Review approved
- `(Not in MVP) 👎 Changes` - Changes requested
- `👀 PR #42` - PR created and linked
- Iteration Badges:
  - `👎 PR #42 (iterate #1st)` - Iteration 1
  - `👎 PR #42 (iterate #Nth)` - Iteration N

Iteration only count after first review rejection. After that, it's just a count of how many times the mission has been rejected.

### Workflow State Transitions

#### Direct Push Mode Flow
```
Todo (Direct) → Doing (Working) → Done (Complete)
...
Todo (PR Mode) → Doing (Working) → Review (PR Created) → Done (Merged)
                ...
                ↳ or, iterate with review feedback
```
